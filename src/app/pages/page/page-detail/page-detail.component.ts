        ...
        tap(({ table, title }) => {
          ...
          if (table.links && table.childOf) {
            ...
            table = {
              ...
              links: {
                ...table.links,
                getPath: `${table.links.getPath}/${this.activatedRoute.snapshot.params.id}/requestitems`,
                createPath: `${table.links.getPath}/${this.activatedRoute.snapshot.params.id}/requestitems`,
                updatePath: `${table.links.getPath}/${this.activatedRoute.snapshot.params.id}/requestitems/[id]`
                // Chaild Links
